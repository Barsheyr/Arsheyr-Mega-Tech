...
//   return (
//     <div>
//       <footer className="footer p-10 bg-gradient-to-r from-black via-gray-800 to-black text-white">
...
//                 height="24"
//                 viewBox="0 0 24 24"
//                 className="fill-current hover:text-blue-700 transition-colors"
//               >
//                 <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"></path>
//               </svg>
//             </a>
...
const Footer = () => {
  return (
    <div>
      <footer className="bg-gradient-to-r from-blue-900 via-gray-800 to-black text-white p-10">
        <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          {/* Services Section */}
          <nav>
            <h6 className="footer-title text-xl font-semibold mb-4">
              Services
            </h6>
            <div className="flex flex-col gap-5">
              <a
                href="#"
                className="link link-hover text-sm hover:text-blue-400 transition-all mb-2"
              >
                Branding
              </a>
              <a
        ...
        <div className="mt-10 text-center">
          ...
          <div className="flex justify-center space-x-4">
            ...
            />
            <button className="bg-blue-600 text-white p-2 rounded-md hover:bg-blue-500 transition-colors">
              Subscribe
            </button>
          </div>
        </div>
      ...
      {/* Bottom Section with Brand Info & Social Media */}
